...
const meetings: CalendarMeeting[] = [
  // Alex Rivera - emp-001 (moderate meeting load)
  ...
  { id: 'cal-3', employeeId: 'emp-001', title: '1:1 with Jordan', startTime: '2026-04-02T10:00', endTime: '2026-04-02T10:30', type: 'manager_org', durationMinutes: 30 },
  ...
  // Blake Torres - emp-002 (low meeting load)
  ...
  { id: 'cal-11', employeeId: 'emp-002', title: '1:1 with Jordan', startTime: '2026-04-02T11:00', endTime: '2026-04-02T11:30', type: 'manager_org', durationMinutes: 30 },
  ...
  // Casey Nair - emp-003 (heavy meeting load)
  ...
  { id: 'cal-23', employeeId: 'emp-003', title: '1:1 with Jordan', startTime: '2026-04-02T14:00', endTime: '2026-04-02T14:30', type: 'manager_org', durationMinutes: 30 },
  ...
  // Drew Park - emp-004 (moderate meeting load)
  ...
  { id: 'cal-41', employeeId: 'emp-004', title: '1:1 with Jordan', startTime: '2026-04-03T10:00', endTime: '2026-04-03T10:30', type: 'manager_org', durationMinutes: 30 },
